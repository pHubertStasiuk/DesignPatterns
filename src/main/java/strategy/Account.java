...
public class Account {
    ...
    private InterestCalculatorStrategy interestStrategy;
    ...
    public Account(long accountNo, String accountHolderName, AccountType accountType,
                   InterestCalculatorStrategy interestStrategy) {
    ...
    public InterestCalculatorStrategy getInterestStrategy() {
        return interestStrategy;
    }
    public void setInterestStrategy(InterestCalculatorStrategy interestStrategy) {
        this.interestStrategy = interestStrategy;
    }
